...
total_combinations = [["single_a","single_b","single_c","bdouble_a","bdouble_b","bdouble_c","rigid_a","standalone","total_pallets"]]
                                                ...
                                                for ra in rigid_a:
                                                    ...
                                                    if tpallet < limit:
                                                        for e in extra:
                                                            ...
                                                            tpallet += epallet
                                                            if tpallet < limit:
                                                                total_combinations.append([sa,sb,sc,ba,bb,bc,ra,e,tpallet])
                                                                print([sa,sb,sc,ba,bb,bc,ra,e])
                                                                print(tpallet)
                                                            else:
                                                                print("BREAK Extra")
                                                                tpallet = e_round
